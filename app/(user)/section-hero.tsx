  ...
  return (
    <section className="w-full h-screen lg:h-auto lg:mt-6">
      <Image
        ...
        alt=""
        aria-hidden
        className="object-cover h-screen lg:h-auto lg:object-none lg:rounded-4xl lg:mx-auto lg:max-w-[95%]"
      />

      <div className="absolute top-[calc(50%+2.5rem)] left-1/2 -translate-1/2 lg:top-0 lg:left-0 lg:translate-0 lg:relative lg:-mt-30 content flex flex-col items-center max-w-9/10 xl:max-w-6xl">
        <div className="min-h-30 relative bg-black/50 w-full gap-y-1 py-4 px-4 lg:pb-0 rounded-4xl lg:rounded-b-none mb-16">
