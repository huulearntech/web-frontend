        ...
        <div className="flex justify-between sticky top-15 md:top-20.5 border-b p-3 -mt-3 z-10 bg-background shadow-md">
          ...
          <div className="flex gap-x-4">
            ...
            <Link
              href={"#"}
              target="_blank"
              className="bg-primary text-primary-foreground text-sm font-bold px-3 py-2 rounded-full whitespace-nowrap overflow-hidden overflow-ellipsis flex items-center gap-x-2"
            >
