...
import { Form, Input, Row, Col, Steps, Divider, Radio, Select, Tooltip, Carousel } from 'antd';
                  ...
                  <div className="bg-white rounded-lg shadow-md">
                    ...
                    <div className="p-4 flex space-x-2 mb-4">
                      <div className="flex flex-col space-y-1 flex-1 items-center rounded-lg border border-gray-300 p-2">
                        ...
                        <span className="text-xs font-semibold">Ngày nhận</span>
                      ...
                      <div className="flex flex-col space-y-1 flex-1 items-center rounded-lg border border-gray-300 p-2">
                        ...
                        <span className="text-xs font-semibold">Ngày trả</span>
