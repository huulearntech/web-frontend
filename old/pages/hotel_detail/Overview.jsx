  ...
  return (
    <div id='overview' className="w-full flex flex-col space-y-4 rounded-lg overflow-hidden">
      <Image.PreviewGroup preview={{ toolbarRender: () => null }}>
        <Row gutter={[8, 0]}>
          <Col span={9}>
            {/* Can't work around with ant-design */}
            {/* <Image src={hotel.images[0]} alt={`Image 1`} wrapperStyle={{ height: '100%', width: '100%' }} style={{ objectFit: 'cover' }}/> */}
            <img src={hotel.images[0]} alt={`Image 1`} style={{ height: '100%', width: '100%', objectFit: 'cover' }}/>
          </Col>
