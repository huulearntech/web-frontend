...
function HotelCard({
  ...
  const { id, name, imageUrls, wardId, rating,
    ...
    >
      <div className="relative h-40 shrink-0 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 bg-black/40 text-primary-foreground inline-flex rounded-br-lg items-center px-2 py-1 text-sm font-semibold">
          ...
          {`Ward id: ${wardId}` // TODO: This should be ward name, not id
          }
        </div>
      ...
      <div className="flex flex-col justify-between px-3 py-2 flex-1">
        <div className="flex flex-col gap-y-1">
          ...
          <div className='flex items-center space-x-1 ml-1'>
            ...
            <span className="text-xs font-semibold whitespace-nowrap overflow-hidden overflow-ellipsis flex-1">{/** location */} location goes here</span>
          </div>
        ...
        <div className="flex justify-between items-end">
          <div className="flex flex-col w-full gap-y-1">
            ...
            <div className="font-bold text-orange-600">{/** price */} price goes here VND</div>
